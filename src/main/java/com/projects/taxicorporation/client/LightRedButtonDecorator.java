...
public class LightRedButtonDecorator extends ButtonDecorator {
    public LightRedButtonDecorator(ButtonPrototype decoratedButton) {
    ...
    public void draw(Controller controller, HandleButtonClick handleButtonClick) {
        ...
        button.setStyle("-fx-background-color: rgb(246,162,162)");
