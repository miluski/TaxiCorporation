...
public class DeleteReservationTask extends Task implements Runnable {
    private final Socket clientSocket;
    private List<String> data;
    public DeleteReservationTask(Socket clientSocket) {
    ...
    public void sendRequest() {
        ...
        Command<String> deleteReservationCommand = new DeleteReservationCommand();
        ConcreteCommunicateMediator concreteCommunicateMediator = new ConcreteCommunicateMediator(deleteReservationCommand, abstractDataBase);
