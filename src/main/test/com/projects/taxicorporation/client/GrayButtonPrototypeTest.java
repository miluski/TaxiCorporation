...
class GrayButtonPrototypeTest {
    ...
    void accessors_and_mutators_shouldWorkCorrectly() {
        GrayButtonPrototype button = new GrayButtonPrototype();
