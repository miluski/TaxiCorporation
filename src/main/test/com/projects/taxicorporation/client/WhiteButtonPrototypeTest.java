...
class WhiteButtonPrototypeTest {
    ...
    void accessors_and_mutators_shouldWorkCorrectly() {
        WhiteButtonPrototype button = new WhiteButtonPrototype();
