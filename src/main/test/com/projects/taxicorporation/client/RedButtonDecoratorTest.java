...
class RedButtonDecoratorTest {
    ...
    void draw_shouldCreateBlackButtonWithCorrectProperties(FxRobot robot) throws TimeoutException {
        ...
        RedButtonDecorator redButtonDecorator = new RedButtonDecorator(decoratedButton);
        Button createdButton = getButton(decoratedButton);
        robot.interact(() -> redButtonDecorator.draw(addManagerController, null));
    ...
    private static Button getButton(ButtonPrototype decoratedButton) {
        ...
        createdButton.setStyle("-fx-background-color: rgb(222,20,20)");
