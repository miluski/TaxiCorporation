...
public class GrayButtonDecoratorTest {
    ...
    void draw_shouldCreateGrayButtonWithCorrectProperties(FxRobot robot) throws TimeoutException {
        ...
        GrayButtonDecorator grayButtonDecorator = new GrayButtonDecorator(decoratedButton);
        Button createdButton = getButton(decoratedButton);
        robot.interact(() -> grayButtonDecorator.draw(addManagerController, null));
    ...
    private static Button getButton(ButtonPrototype decoratedButton) {
        ...
        createdButton.setStyle("-fx-background-color: rgb(134,134,134)");
