...
class BlackButtonDecoratorTest {
    private static AddManagerController addManagerController;

    @Test
    void draw_shouldCreateBlackButtonWithCorrectProperties(FxRobot robot) throws TimeoutException {
        ...
        BlackButtonDecorator blackButtonDecorator = new BlackButtonDecorator(decoratedButton);
        Button createdButton = getButton(decoratedButton);
        robot.interact(() -> blackButtonDecorator.draw(addManagerController, null));
    ...
    private static Button getButton(ButtonPrototype decoratedButton) {
        ...
        createdButton.setStyle("-fx-background-color: rgb(0,0,0)");
