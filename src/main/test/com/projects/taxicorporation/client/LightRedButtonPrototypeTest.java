...
class LightRedButtonPrototypeTest {

    @Test
    void clone_shouldReturnCloneWithSameProperties() throws CloneNotSupportedException {
        LightRedButtonPrototype original = new LightRedButtonPrototype();
        original.setText("Original Text");
        original.setWidth(100.0);
        original.setHeight(30.0);
        original.setX(50.0);
        original.setY(20.0);
        LightRedButtonPrototype clone = (LightRedButtonPrototype) original.clone();
    ...
    void accessors_and_mutators_shouldWorkCorrectly() {
        LightRedButtonPrototype button = new LightRedButtonPrototype();
