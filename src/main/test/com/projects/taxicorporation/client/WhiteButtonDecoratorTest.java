...
public class WhiteButtonDecoratorTest {
    private static AddManagerController addManagerController;

    @Test
    void draw_shouldCreateWhiteButtonWithCorrectProperties(FxRobot robot) throws TimeoutException {
        ...
        WhiteButtonDecorator whiteButtonDecorator = new WhiteButtonDecorator(decoratedButton);
        Button createdButton = getButton(decoratedButton);
        robot.interact(() -> whiteButtonDecorator.draw(addManagerController, null));
    ...
    private static Button getButton(ButtonPrototype decoratedButton) {
        ...
        createdButton.setStyle("-fx-background-color: rgb(255,255,255)");
