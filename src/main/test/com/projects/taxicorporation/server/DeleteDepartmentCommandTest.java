...
class DeleteDepartmentCommandTest {
    @Test
    void testExecuteWithEmptyDataList() throws SQLException {
        DeleteDepartmentCommand deleteDepartmentCommand = new DeleteDepartmentCommand();
        ...
        assertThrows(IndexOutOfBoundsException.class, () -> {
            deleteDepartmentCommand.execute(emptyDataList, someMockConnection);
        });
    }
}
