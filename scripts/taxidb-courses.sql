...
INSERT INTO addresses (id_address, city, street) VALUES (addresses_seq.NEXTVAL, 'Kielce', 'Swietokrzyska');
...
-- set user rank to admin for first user in database
UPDATE users SET id_user_role = 1 WHERE id_user = 1; -- uncomment only when user exists in database!